      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative">
          <select
            ...
            className="pl-8 pr-4 py-2 bg-white border rounded-lg text-sm appearance-none cursor-pointer focus:ring-2 focus:ring-rose-500"
          >
          ...
          <div>
            <div className="flex flex-wrap gap-1">
              {data.moods.map((m, i) => (
                <span
                  key={i}
                  className="px-2 py-0.5 bg-sky-50 text-sky-700 text-xs rounded"
                >
